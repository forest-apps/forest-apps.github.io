...
{{< cards cols="1" >}}
  {{< card
    ...
    subtitle="Evaluate vessel station-keeping limits under combined wind, wave, and current loads." 
    image="./images/Feature-Dp-Capability-Assessment.png"  >}}

  {{< card
    title="Robust Thrust Allocation" 
    subtitle="Advanced algorithms distribute thrust efficiently while respecting operational constraints." 
    image="./images/Feature-Robust-Thrust-Allocation.png"  >}}

  {{< card
    title="Environmental Load Modeling" 
    subtitle="Built-in support for wind, wave, and current forces acting on the vessel." 
    image="./images/Feature-Environmental-Load-Modeling.png"  >}}

  {{< card 
    title="Failure Mode Analysis" 
    subtitle="Assess DP performance under thruster and power failure scenarios." 
    image="./images/Feature-Failure-Mode-Analysis.png"  >}}

  {{< card
    title="Capability & Feasibility Plots" 
    subtitle="Clear rose plots and visual outputs for operability assessment." 
    image="./images/Feature-Capability-Feasibility-Plots.png"  >}}

  {{< card
    title="One-Stop Reporting" 
    subtitle="Automatically generate comprehensive engineering reports." 
    image="./images/Feature-One-Stop-Reporting.png"  >}}
{{< /cards >}}
